...
elseif i > idx then
extstate._forever[string.format("fx_properties.excludeMask%u.fx", i-1)] = extstate._layout[string.format("excludeMask%u.fx", i)]
extstate._forever[string.format("fx_properties.excludeMask%u.param", i-1)] = extstate._layout[string.format("excludeMask%u.param", i)]
extstate._forever[string.format("fx_properties.excludeMask%u.fx", i)] = nil
extstate._forever[string.format("fx_properties.excludeMask%u.param", i)] = nil
end
i = i+1
